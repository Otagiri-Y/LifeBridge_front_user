...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ページ遷移後の処理をするために、必要ならコンテキストプロバイダーなどで
      // トークンを管理する実装に変更することも検討できる
    } catch (err) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg text-blue-600 hover:bg-gray-50 focus:outline-none"
              >
                <svg
              ...
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none"
              >
