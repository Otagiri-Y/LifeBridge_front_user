...
const jobCategories = [
  ...
  { id: "corporate", name: "コーポレートスタッフ", detail: "経理・人事・総務・法務・情報システム・広報・・・" },
  { id: "scm", name: "SCM/生産管理/購買/物流", detail: "生産管理・購買・物流・貿易事務" },
  { id: "admin", name: "事務/受付/秘書/翻訳", detail: "一般事務・営業事務・受付・翻訳" },
  { id: "retail", name: "小売販売/流通", detail: "販売スタッフ・店舗・仕入/流通・店舗開発・・・" },
  { id: "service", name: "サービス/接客", detail: "客室・フロア・アミューズメント・イベント・旅行・・・" },
  { id: "education", name: "教育", detail: "ホールスタッフ・調理スタッフ・店長・支配人・・・" },
  { id: "consulting", name: "コンサル/士業/リサーチャー", detail: "コンサルタント・士業・調査/分析・会計士・・・" },
  { id: "it", name: "IT", detail: "エンジニア・プロジェクトリーダー・プロジェクト・・・" },
  { id: "creative", name: "クリエイティブ/デザイン職", detail: "WEBデザイン・動画/グラフィック/ゲーム・・・" },
];
      ...
      <main className="flex-grow px-4 pt-4 pb-24">
        ...
        <div className="fixed bottom-16 left-0 right-0 flex items-center justify-between px-4 py-3 bg-white border-t">
          ...
          <button
            ...
            className={`px-8 py-3 rounded-full text-white ${selectedJobType ? "bg-blue-700" : "bg-gray-400"}`}
          >
            {loading ? "処理中..." : "次へ進む"}
          </button>
        </div>
